...
$(function() {	
	...
	$("#editEvent").unbind('click').click(function() {	
		$("#floatDiv").removeClass("invisible");		
		$(".redit").addClass("invisible");	
		...
		$.ajax(
	    {
	        ...
	        data: "reserve_id=" + eventid + "&reserve_roomid=" + room + "&reserve_eventname=" + eventname + "&reserve_datein=" + datein + "&reserve_timein=" + timein + "&reserve_timeout=" + timeout + "&reserve_person=" + person + "&reserve_notes=" + notes + "&reserve_reason=" + reason + "&user_fullname=" + fullname + "&user_email=" + email + "&reserve_user=" + ruser,
	        type: "POST",
	        success: function(data) {
	            $(".rconinfo").html(data);
	        }
	...
	$("#delEvent").unbind('click').click(function() {
		...
		$.ajax(
	    {
	        ...
	        data: "resid=" + eventid + "&reserve_reason=" + reason + "&user_fullname=" + fullname + "&user_email=" + email + "&reserve_user=" + ruser,
	        type: "POST",
	        complete: function(){
	        	$("#loading").hide();
	    	},
